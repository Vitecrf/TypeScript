...
let set1 = new Set<number>([1,2,3,4,5,6,7,8,9]);
let set2 = new Set<number>([1,3,6,7,9]);
...
let res: Array<number> = intersection(set1, set2);
console.log(res);
...
let res1: Array<number> = sbtract(set1, set2);
console.log(res1);

//======================2=========================
const arr: Array<string> = ['Imn', 'cb', 'ab', 'a', 'a', 'cb', 'lm', 'cd', 'Imn', 'ab', 'cb'];
...
function getSortedOccurrences(array: string[]): Occurrency[]{
    let mapArr = new Map<string, number>([]);
